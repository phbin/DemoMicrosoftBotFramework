...
namespace mainDemo.Dialogs.Flowers
{
    public class FlowerDetailsDialog:WaterfallDialog
    {
        public FlowerDetailsDialog(string dialogId, IEnumerable<WaterfallStep> steps = null) : base(dialogId, steps)
        {
        ...
        public static string Id => "checkFlowerDetailsDialog";
        public static FlowerDetailsDialog Instance { get; } = new FlowerDetailsDialog(Id);
    }
}
